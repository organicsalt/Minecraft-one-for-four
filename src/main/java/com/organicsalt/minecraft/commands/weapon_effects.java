            ...
            if (s.equalsIgnoreCase("weapon_effects")){
                if(strings.length==1){
                    ...
                    if(strings[0].equalsIgnoreCase("on")){//如果是开启武器特效指令
                        ...
                        if(true){//如果武器特效尚未开启
                            //开启武器特效
                            commandSender.sendMessage("武器特效开启成功!");
                        }
                        else{//如果武器特效已经开启
                            commandSender.sendMessage("武器特效已开启!");
                        }
                    }
